// Custom Messages
export const heCustomMessages = {
    mySecuritiesStatus: 'מצב הנכסים שלי',
    mySecurities: 'הנכסים שברשותי',
    dashboard: 'Dashboard',
    planning: 'Planning',
    profile: 'מידע אישי',
    info: 'מידע',
    ...
    trend: 'Trend',
    volume: 'כמות',
    childDisplay: 'תצוגת ילד',
    adultDisplay: 'תצוגת בוגר',
    ...
    ClosingPrice: 'מחיר סגירה',
    rating: 'דירוג נייר',
    PercentageChange: 'אחוז שינוי',
    budget: 'Budget',
    contacts: 'Contacts',
    address: 'Address',
    phone: 'פלאפון',
    gridSearch: 'חיפוש ערך בכלל העמודות..',
    exportExcel: 'ייצוא לאקסל',
    exportPdf: 'ייצוא מסמך להדפסה'
};

// Kendo Angular Component Messages
export const heComponentMessages = {
    // Grid
    ...
    'kendo.grid.pagerFirstPage': 'דפדף לעמוד הראשון',
    'kendo.grid.pagerPreviousPage': 'עמוד הקודם',
    'kendo.grid.pagerNextPage': 'עמוד הבא',
    'kendo.grid.pagerLastPage': 'דפדף לעמוד האחרון',
    'kendo.grid.pagerPage': 'דף',
    'kendo.grid.pagerOf': 'מתוך',
    'kendo.grid.pagerItems': 'פריטים',
    'kendo.grid.pagerItemsPerPage': 'פריטים בדף',
    'kendo.grid.pagerPageNumberInputTitle': 'מס דף',
    'kendo.grid.filter': 'חיפוש',
    'kendo.grid.filterEqOperator': 'שווה ל',
    'kendo.grid.filterNotEqOperator': 'אינו שווה ל',
    'kendo.grid.filterIsNullOperator': 'ריק',
    'kendo.grid.filterIsNotNullOperator': 'לא ריק',
    ...
    'kendo.grid.filterContainsOperator': 'מכיל',
    'kendo.grid.filterNotContainsOperator': 'אינו מכיל',
    'kendo.grid.filterEndsWithOperator': 'מסתיים ב',
